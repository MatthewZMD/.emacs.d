...
(if (fboundp 'register-definition-prefixes) (register-definition-prefixes "format-all" '("format-all-" "shfmt" "sqlformat" "swiftformat" "rufo" "rustfmt" "perltidy" "prettier" "ocp-indent" "mix-format" "lua-fmt" "ktlint" "html-tidy" "gofmt" "elm-format" "emacs-lisp" "define-format-all-formatter" "dartfmt" "dfmt" "dhall" "crystal" "black" "brittany" "asmfmt")))

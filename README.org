...
** Python
   *Prerequisite*:
   Install Python3 with =pip= and verify they are in the PATH. Then execute the following commands.
   #+BEGIN_SRC text
     pip install jedi flake8 autopep8 importmagic yapf
     pip install virtualenv pyls-mypy

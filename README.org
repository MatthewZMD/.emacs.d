...
*** TOC Org
    ...
    #+END_SRC
** Dired
   Configure Dired, the directory editor.
   #+BEGIN_SRC emacs-lisp
...
** C/C++
   *Prerequisite*: To compile and execute C/C++ files in Emacs for Windows, install [[http://www.mingw.org/wiki/Install_MinGW][MinGW]] first.
   ...
   #+END_SRC
*** Irony
    [[https://github.com/Sarcasm/irony-mode][Irony mode]] is an Emacs minor mode that supports code completion, syntax checking, etc.

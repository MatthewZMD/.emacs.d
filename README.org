...
** Highlight Indent Guides
   ...
   #+END_SRC
** LSP
   [[https://github.com/emacs-lsp/lsp-mode][LSP]], a client/library for the [[https://microsoft.github.io/language-server-protocol/][*L*anguage *S*erver *P*rotocol]].
*** LSP Mode
    #+BEGIN_SRC emacs-lisp
...
*** Company LSP
    ...
    #+END_SRC
*** DAP
    [[https://github.com/emacs-lsp/dap-mode][DAP]], a client/library for the [[https://code.visualstudio.com/api/extension-guides/debugger-extension][*D*ebug *A*dapter *P*rotocol]].
    #+BEGIN_SRC emacs-lisp
...
** Python
   *Prerequisite*:
   Install Python and =pip= and verify they are in the PATH. Then execute the following code.
   #+BEGIN_SRC text
     pip install jedi flake8 autopep8 importmagic yapf virtualenv
   #+END_SRC
   Verify =virtualenv= is in the PATH too. Now execute =M-x jedi:install-server=.
*** Jedi

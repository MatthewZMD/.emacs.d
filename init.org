...
** Early-Init
   Emacs27 introduces =early-init.el=, which is run before init.el, packages and ui initializations.
*** Defer Garbage Collection
    Defer garbage collection further back in the startup process.
    #+INCLUDE: "~/.emacs.d/early-init.el" src emacs-lisp :range-begin "DeferGC" :range-end "-DeferGC"  :lines "46-47"
*** Disable =package-enable-at-startup=
    ...
    #+INCLUDE: "~/.emacs.d/early-init.el" src emacs-lisp :range-begin "PackageEnableStartupNil" :range-end "-PackageEnableStartupNil"  :lines "50-51"
*** Disable Unnecessary Interface
    It will be faster to disable them here before they've been initialized.
    #+INCLUDE: "~/.emacs.d/early-init.el" src emacs-lisp :range-begin "DisableUnnecessaryInterface" :range-end "-DisableUnnecessaryInterface" :lines "54-58"
** Optimization
   Unset file name handler alist.
   #+INCLUDE: "~/.emacs.d/init.el" src emacs-lisp :range-begin "UnsetFNHA" :range-end "-UnsetFNHA" :lines "60-62"
   Garbage collect when Emacs is idle.
   #+INCLUDE: "~/.emacs.d/init.el" src emacs-lisp :range-begin "AutoGbgCollect" :range-end "-AutoGbgCollect" :lines "65-66"
   Reset GC Threshold after some deferred time from [[https://emacs.stackexchange.com/a/34367][blujay]].
   #+INCLUDE: "~/.emacs.d/init.el" src emacs-lisp :range-begin "ResetGC" :range-end "-ResetGC" :lines "69-77"
** Load-Path
...
** Configure Package Management
   #+INCLUDE: "~/.emacs.d/elisp/init-package.el" src emacs-lisp :range-begin "ConfigurePackageManagement" :range-end "-ConfigurePackageManagement" :lines "58-70"
** Use-Package Wrapper
   ...
   #+INCLUDE: "~/.emacs.d/elisp/init-package.el" src emacs-lisp :range-begin "UsePackageWrapperMacro" :range-end "-UsePackageWrapperMacro"  :lines "73-99"
   The =use-package= wrapper.
   #+INCLUDE: "~/.emacs.d/elisp/init-package.el" src emacs-lisp :range-begin "DefPackage" :range-end "-DefPackage" :lines "102-111"
** Auto Package Update
   ...
   #+INCLUDE: "~/.emacs.d/elisp/init-package.el" src emacs-lisp :range-begin "AutoPackageUpdate" :range-end "-AutoPackageUpdate" :lines "114-121"

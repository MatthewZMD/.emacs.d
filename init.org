...
** Projectile
   ...
   *Prerequisite*: Windows OS: Install [[https://github.com/bmatzelle/gow/releases][Gow]] and add to =PATH=.
   ...
   #+INCLUDE: "~/.emacs.d/elisp/init-projectile.el" src emacs-lisp :range-begin "ProjPac" :range-end "-ProjPac" :lines "45-56"
** Treemacs
...
** Emacs Relay Chat
   ...
   *Prerequisite*: Put IRC credentials to =~/.authinfo= or =~/.authinfo.gpg= or =~/.netrc= like this:
   ...
   #+END_SRC
   #+INCLUDE: "~/.emacs.d/elisp/init-erc.el" src emacs-lisp :range-begin "ERCPac" :range-end "-ERCPac" :lines "46-132"
** Emacs Web Wowser

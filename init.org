...
*** Ivy, Amx, Counsel, Swiper
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-ivy.el" src emacs-lisp :range-begin "IvyPac" :range-end "-IvyPac" :lines "42-60"
** Shell
*** Shell Here
...
*** Move Custom-Set-Variables to Different File
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "CustomSetFileLocation" :range-end "-CustomSetFileLocation" :lines "143-145"5
*** So-Long
    So-Long mitigates slowness due to extremely long lines. Currently available in Emacs master branch *only*!
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "SoLong" :range-end "-SoLong" :lines "148-150"
** Functions
...
*** Forge
    ...
    *Prerequisite*: Read [[https://magit.vc/manual/forge/Getting-Started.html#Getting-Started][Getting-Started]] to start using Forge.
    #+INCLUDE: "~/.emacs.d/elisp/init-magit.el" src emacs-lisp :range-begin "ForgePac" :range-end "-ForgePac" :lines "47-48"
** Projectile
...
*** Company Mode
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-company.el" src emacs-lisp :range-begin "ComPac" :range-end "-ComPac" :lines "42-63"
*** Company LSP
    [[https://github.com/tigersoldier/company-lsp][Company LSP]], a Company completion backend for lsp-mode.
    #+INCLUDE: "~/.emacs.d/elisp/init-company.el" src emacs-lisp :range-begin "CompanyLSPPac" :range-end "-CompanyLSPPac" :lines "66-70"
*** Company TabNine
    ...
    *Prerequisite*: Execute =M-x company-tabnine-install-binary= to install the TabNine binary for your system.
    #+INCLUDE: "~/.emacs.d/elisp/init-company.el" src emacs-lisp :range-begin "CompanyTabNinePac" :range-end "-CompanyTabNinePac" :lines "73-84"
* Programming
** Java
*** LSP Java
...
*** Python Configuration
   #+INCLUDE: "~/.emacs.d/elisp/init-python.el" src emacs-lisp :range-begin "PythonConfig" :range-end "-PythonConfig" :lines "46-53"
*** LSP Python MS
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-python.el" src emacs-lisp :range-begin "LSPPythonPac" :range-end "-LSPPythonPac" :lines "56-60"
** Arduino
*** Arduino Mode

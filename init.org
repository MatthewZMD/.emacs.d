...
*** Magit
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-magit.el" src emacs-lisp :range-begin "MagitPac" :range-end "-MagitPac" :lines "45-47"
*** Forge
    ...
    *Prerequisite*: Make sure you have GCC and then read [[https://magit.vc/manual/forge/Getting-Started.html#Getting-Started][Getting-Started]] to start using Forge.
    #+INCLUDE: "~/.emacs.d/elisp/init-magit.el" src emacs-lisp :range-begin "ForgePac" :range-end "-ForgePac" :lines "50-52"
** Projectile
...
*** Company TabNine
    ...
    *Prerequisite*: Execute =M-x company-tabnine-install-binary= to install the TabNine binary for your system.
    #+INCLUDE: "~/.emacs.d/elisp/init-company.el" src emacs-lisp :range-begin "CompanyTabNinePac" :range-end "-CompanyTabNinePac" :lines "67-91"
* Programming
** Java
*** LSP Java

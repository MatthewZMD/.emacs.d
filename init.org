...
*** Where Am I
    #+INCLUDE: "~/.emacs.d/elisp/init-func.el" src emacs-lisp :range-begin "WhereAmI" :range-end "-WhereAmI" :lines "187-191"
*** Get File Name From Path
    #+INCLUDE: "~/.emacs.d/elisp/init-func.el" src emacs-lisp :range-begin "GetFileNameFromPath" :range-end "-GetFileNameFromPath" :lines "194-198"
*** Edit This With Sudo
    #+INCLUDE: "~/.emacs.d/elisp/init-func.el" src emacs-lisp :range-begin "EditThisWithSudo" :range-end "-EditThisWithSudo" :lines "201-211"
...
*** Dashboard
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-dashboard.el" src emacs-lisp :range-begin "DashboardPac" :range-end "-DashboardPac" :lines "41-76"
*** Page Break Lines
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-dashboard.el" src emacs-lisp :range-begin "PBLPac" :range-end "-PBLPac" :lines "79-82"
** Fonts and Icons
...
** EAF
   ...
   *Prerequisite*: Please install =python3= and =pip3=. Then execute below command:
   ...
   #+END_SRC
   #+INCLUDE: "~/.emacs.d/elisp/init-eaf.el" src emacs-lisp :range-begin "EAFPac" :range-end "-EAFPac" :lines "44-68"
** ERC

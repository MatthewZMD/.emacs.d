...
*** Usage
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-ein.el" src emacs-lisp :range-begin "EINPac" :range-end "-EINPac" :lines "40-42"
* Programming
...
** TODO Debug Adapter Protocol
   ...
   #+INCLUDE: "~/.emacs.d/elisp/init-lsp.el" src emacs-lisp :range-begin "DAPPac" :range-end "-DAPPac" :lines "96-102"
** Java
*** LSP Java
    ...
    *Prerequisite*: Install [[https://maven.apache.org/download.cgi][Maven]] and add to =PATH=.
    #+INCLUDE: "~/.emacs.d/elisp/init-lsp.el" src emacs-lisp :range-begin "LSPJavaPac" :range-end "-LSPJavaPac" :lines "108-117"
** C/C++
   *Prerequisite*:
...
*** Arduino Mode
    ...
    - Currently Off
    #+INCLUDE: "~/.emacs.d/elisp/init-arduino.el" src emacs-lisp :range-begin "ArduinoPac" :range-end "-ArduinoPac" :lines "40-46"
*** Company Arduino
    ...
    - Currently Off
    #+INCLUDE: "~/.emacs.d/elisp/init-arduino.el" src emacs-lisp :range-begin "CompanyArduinoPac" :range-end "-CompanyArduinoPac" :lines "49-55"

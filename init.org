...
* About M-EMACS
  ...
  This distribution is designed and tested for *GNU Emacs 26.1 and above only*. However, it is suggested to use *Emacs 27*, the latest stable version released, for its significant improvement in the core that's out of the scope of M-EMACS.

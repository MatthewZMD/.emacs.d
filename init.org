...
*** Optimize Editing Experience
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "EditExp" :range-end "-EditExp" :lines "78-112"
*** History
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "History" :range-end "-History" :lines "115-139"
*** Small Configs
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "SmallConfigs" :range-end "-SmallConfigs" :lines "142-178"
** Functions
   Important functions.
...
** EAF
   ...
   *Prerequisite*: Please install =python3= and =pip3=. Then execute below command:
   ...
   #+END_SRC
   #+INCLUDE: "~/.emacs.d/elisp/init-eaf.el" src emacs-lisp :range-begin "EAFPac" :range-end "-EAFPac" :lines "44-62"
** ERC
...
** Mu4e
   ...
   *Prerequisite*:
   1. Install [[https://www.djcbsoftware.nl/code/mu/][mu]] on your machine.
   2. Configure [[https://wiki.archlinux.org/index.php/Isync][mbsync]] or [[https://www.offlineimap.org/][offlineimap]], I suggest walk through this [[https://www.reddit.com/r/emacs/comments/bfsck6/mu4e_for_dummies/][tutorial]].
   #+INCLUDE: "~/.emacs.d/elisp/init-mu4e.el" src emacs-lisp :range-begin "Mu4ePac" :range-end "-Mu4ePac" :lines "42-107"
** Tramp

...
* Installation
  ...
  6. Restart Emacs.
* Modification
  You have the permission to use, modify, distribute however you want and free of charge, but without any warranty. (See [[file:LICENSE][LICENSE]])
...
** Define Constants
   #+INCLUDE: "~/.emacs.d/elisp/init-const.el" src emacs-lisp :range-begin "Consts" :range-end "-Consts"  :lines "45-57"
* Package Management
** Melpa Packages
...
** Owner Information
   *Prerequisite*: Change this to your information.
   #+INCLUDE: "~/.emacs.d/elisp/init-const.el" src emacs-lisp :range-begin "UserInfo" :range-end "-UserInfo"" :lines "60-62"
** Bindings
...
** Search
   ...
   *Prerequisite*: Please follow the [[https://github.com/BurntSushi/ripgrep#installation][installation]] to install ripgrep and verify =rg= is in the =PATH=.
   #+INCLUDE: "~/.emacs.d/elisp/init-search.el" src emacs-lisp :range-begin "SrPac" :range-end "-SrPac" :lines "49-56"
** Avy
...
*** UTF-8 Coding System
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "UTF8Coding" :range-end "-UTF8Coding" :lines "60-70"
*** Turn Off Cursor Alarms
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "RingBell" :range-end "-RingBell" :lines "73-74"
*** Turn Off Blink Cursor
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "OffBlink" :range-end "-OffBlink" :lines "77-78"
...
*** Optimize Editing Experience
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "EditExp" :range-end "-EditExp" :lines "85-106"
*** Automatic Garbage Collect
    Garbage collect when Emacs is not in focus.
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "AutoGbgCollect" :range-end "-AutoGbgCollect" :lines "109-110"
*** MiniBuffer
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "BetterMiniBuffer" :range-end "-BetterMiniBuffer" :lines "113-118"
*** Don't Lock Files
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "CreateLockFile" :range-end "-CreateLockFile" :lines "121-122"
*** Longer History Length
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "HisLen" :range-end "-HisLen" :lines "125-126"
*** Compilation
    Better compilation configurations.
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "BetterCompilation" :range-end "-BetterCompilation" :lines "129-134"
*** Move Custom-Set-Variables to Different File
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "CustomSetFileLocation" :range-end "-CustomSetFileLocation" :lines "137-139"
** More Functions
   Other important, but longer functions.
*** Resize Window Width / Height Functions
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "ResizeWidthheight" :range-end "-ResizeWidthheight" :lines "144-165"
*** Edit This Configuration File Shortcut
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "EditConfig" :range-end "-EditConfig" :lines "168-174"
*** Smarter Move Beginning of Line
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "MoveBeginningLine" :range-end "-MoveBeginningLine" :lines "177-203"
*** Update Org Mode Include Automatically
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "OrgIncludeAuto" :range-end "-OrgIncludeAuto" :lines "206-251"
...
** Doom Modeline
   ...
   #+INCLUDE: "~/.emacs.d/elisp/init-doom.el" src emacs-lisp :range-begin "DoomModeline" :range-end "-DoomModeline" :lines "58-69"
** Dashboard
*** Dashboard
...
** Highlight Indent Guides
   ...
   #+INCLUDE: "~/.emacs.d/elisp/init-highlight-indent.el" src emacs-lisp :range-begin "HighLightIndentPac" :range-end "-HighLightIndentPac" :lines "47-56"
** Header
...
*** Company LSP
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-lsp.el" src emacs-lisp :range-begin "LSPCompany" :range-end "-LSPCompany" :lines "96-99"
*** DAP
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-lsp.el" src emacs-lisp :range-begin "DAPPac" :range-end "-DAPPac" :lines "102-108"
* Programming
** Emacs Lisp
...
*** LSP Java
    ...
    *Prerequisite*: Install [[https://maven.apache.org/download.cgi][Maven]] and ensure it is in =PATH=.
    #+INCLUDE: "~/.emacs.d/elisp/init-lsp.el" src emacs-lisp :range-begin "LSPJavaPac" :range-end "-LSPJavaPac" :lines "113-116"
** C/C++
   *Prerequisite*:
   ...
   - ALl OS: Install [[https://clang.llvm.org/extra/clangd/Installation.html][Clangd]] and put it in =PATH=.
...
*** TODO Microsoft's Python Language Server - [[https://github.com/melpa/melpa/pull/6027][Use Melpa Once it's Ready]]
    ...
    *Prerequisite*:
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-lsp.el" src emacs-lisp :range-begin "LSPPythonPac" :range-end "-LSPPythonPac" :lines "119-130"
** Arduino
*** Arduino Mode

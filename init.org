...
*** Vterm
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-shell.el" src emacs-lisp :range-begin "VTermPac" :range-end "-VTermPac" :lines "90-100"
*** Shell Here
...
*** Exec Path From Shell
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-shell.el" src emacs-lisp :range-begin "ExecPathFromShellPac" :range-end "-ExecPathFromShellPac" :lines "103-113"
** Sudo Edit

...
*** Garbage Collect When Emacs is Out of Focus
    *Note:* Since Emacs27.1, =focus-out-hook= is obsolete.
    #+INCLUDE: "~/.emacs.d/init.el" src emacs-lisp :range-begin "AutoGC" :range-end "-AutoGC" :lines "68-76"
*** Avoid Garbage Collect When Using Minibuffer
    #+INCLUDE: "~/.emacs.d/init.el" src emacs-lisp :range-begin "MinibufferGC" :range-end "-MinibufferGC" :lines "77-86"
** Load Path

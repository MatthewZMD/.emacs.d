...
** Indentation
   ...
   Indentation Config
   #+INCLUDE: "~/.emacs.d/elisp/init-indent.el" src emacs-lisp :range-begin "IndentConfig" :range-end "-IndentConfig" :lines "59-64"
* Programming
...
*** LSP Java
    ...
    *Prerequisite*: [[https://maven.apache.org/download.cgi][Install]] Maven and add to =PATH=.
    #+INCLUDE: "~/.emacs.d/elisp/init-lsp.el" src emacs-lisp :range-begin "LSPJavaPac" :range-end "-LSPJavaPac" :lines "117-124"
** C/C++
   *Prerequisite*:
...
*** LSP Python MS
    ...
    *Prerequisite*:
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-lsp.el" src emacs-lisp :range-begin "LSPPythonPac" :range-end "-LSPPythonPac" :lines "127-136"
** Arduino
*** Arduino Mode
...
** LeetCode
   ...
   *Prerequisite*: Ensure =cURL= is installed added to =PATH=. If you are using Windows, it is suggested to use =curl= provided by Git, therefore add =<path to Git>\mingw64\bin= to =PATH=.
   #+INCLUDE: "~/.emacs.d/elisp/init-leetcode.el" src emacs-lisp :range-begin "LeetCodePac" :range-end "-LeetCodePac" :lines "49-66"
** Tetris

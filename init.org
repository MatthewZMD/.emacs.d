...
*** LSP Java
    ...
    *Prerequisite*: [[https://maven.apache.org/download.cgi][Install]] Maven and add to =PATH=.
    #+INCLUDE: "~/.emacs.d/elisp/init-lsp.el" src emacs-lisp :range-begin "LSPJavaPac" :range-end "-LSPJavaPac" :lines "117-125"
** C/C++
   *Prerequisite*:
...
*** LSP Python MS
    ...
    *Prerequisite*:
    ...
    #+INCLUDE: "~/.emacs.d/elisp/init-lsp.el" src emacs-lisp :range-begin "LSPPythonPac" :range-end "-LSPPythonPac" :lines "128-138"
** Arduino
*** Arduino Mode

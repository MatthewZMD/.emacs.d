...
** Modification
   ...
   *Remember* you must manually sync this README with all the new changes you made by:
   1. Please do *NOT* edit README.md file, edit [[file:init.org][init.org]] instead!
   ...
   4. Add =#+INCLUDE: "~/.emacs.d/elisp/<place-holder>.el" src emacs-lisp :range-begin "<start-line-wrapper-exclusive>" :range-end "<end-line-wrapper-exclusive>"= in the appropriate section in [[file:init.org][init.org]].
...
** User Information
   *Prerequisite*: Please update this file your personal info.
   #+INCLUDE: "~/.emacs.d/elisp/init-acct.el" src emacs-lisp :range-begin "UserInfo" :range-end "-UserInfo"" :lines "46-48"
** Bindings
...
*** MiniBuffer
	#+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "BetterMiniBuffer" :range-end "-BetterMiniBuffer" :lines "116-121"
*** Don't Lock Files
	#+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "CreateLockFile" :range-end "-CreateLockFile" :lines "124-125"
*** Longer History Length
	#+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "HisLen" :range-end "-HisLen" :lines "128-129"
*** Compilation
...
*** Resize Window Width / Height Functions
	#+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "ResizeWidthheight" :range-end "-ResizeWidthheight" :lines "147-168"
*** Edit This Configuration File Shortcut
	#+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "EditConfig" :range-end "-EditConfig" :lines "171-177"
*** Smarter Move Beginning of Line
	...
	#+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "MoveBeginningLine" :range-end "-MoveBeginningLine" :lines "180-206"
*** Update Org Mode Include Automatically
	...
	#+INCLUDE: "~/.emacs.d/elisp/init-global-config.el" src emacs-lisp :range-begin "OrgIncludeAuto" :range-end "-OrgIncludeAuto" :lines "209-254"
...
** LeetCode
   *Prerequisite*:
   ...
   #+INCLUDE: "~/.emacs.d/elisp/init-acct.el" src emacs-lisp :range-begin "LeetCodeUsr" :range-end "-LeetCodeUsr" :lines "51-53"
   To let Git forget that this file is modified, execute the following.
   #+BEGIN_SRC text
	 cd ~/.emacs.d
	 git update-index --skip-worktree elisp/init-acct.el
   #+END_SRC
   LeetCode package is dependant on [[https://github.com/tkf/emacs-request][Request]], [[https://github.com/tkf/emacs-request/blob/master/request-deferred.el][Request-Deferred]] and [[https://github.com/davazp/graphql-mode][GraphQL]].
   #+INCLUDE: "~/.emacs.d/elisp/init-leetcode.el" src emacs-lisp :range-begin "LeetCodePac" :range-end "-LeetCodePac" :lines "49-58"
** Tetris

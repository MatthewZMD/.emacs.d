...
*** Modifications?
    ...
    *Remember* you must manually sync this README with all the new changes you made by:
    ...
    4. Please do *NOT* edit README.md file, edit [[file:init.org][init.org]] instead!
...
- [[User Interface Enhancements][User Interface Enhancements]]
  ...
  - [[Dashboard][Dashboard]]
  - [[Fonts][Fonts]]
  - [[Zone Screensaver][Zone Screensaver]]
  - [[Diminish][Diminish]]
  - [[Dimmer][Dimmer]]
...
** Disable Unnecessary Interface
   ...
   #+INCLUDE: "~/.emacs.d/init.el" src emacs-lisp :range-begin "DisableUnnecessaryInterface" :range-end "-DisableUnnecessaryInterface" :lines "49-53"
** Optimization
   Avoid garbage collection during startup.
   #+INCLUDE: "~/.emacs.d/init.el" src emacs-lisp :range-begin "AvoidStartupGarbageCollect" :range-end "AvoidStartupGarbageCollect"  :lines "56-65"
   Unset file name handler alist.
   #+INCLUDE: "~/.emacs.d/init.el" src emacs-lisp :range-begin "UnsetFNHA" :range-end "-UnsetFNHA" :lines "68-76"
   Load all elisp files in =elisp/= and =site-elisp/= to reduce startup time.
   #+INCLUDE: "~/.emacs.d/init.el" src emacs-lisp :range-begin "LoadLP" :range-end "-LoadLP"  :lines "79-95"
* Package Management
** Melpa Packages
...
** AG
   ...
   *Prerequisite*: [[https://github.com/k-takata/the_silver_searcher-win32][AG for Windows]] must be installed and put in the Path.
   #+INCLUDE: "~/.emacs.d/elisp/init-ag.el" src emacs-lisp :range-begin "AgPac" :range-end "-AgPac" :lines "48-51"
** Avy
...
** Winner
   ...
   #+INCLUDE: "~/.emacs.d/elisp/init-winner.el" src emacs-lisp :range-begin "WinnerPac" :range-end "-WinnerPac" :lines "48-63"
** Which Key

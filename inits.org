...
** Cool Little Thing About This README                             :noexport:
   This README originated from [[file:init.org][init.org]] that is generated using =M-x org-gfm-export-to-markdown=. Every block of code is generated through this function - it exports the section of code from =elisp/= directory. You will not see their presence in the init file.

   Therefore, you need to manually sync this README with all the new changes you made yourself by adding =#+INCLUDE:= in the appropriate section below and call =M-x org-gfm-export-to-markdown=.
...
** Lexical-binding
   ...
   #+END_QUOTE
   #+INCLUDE: "~/.emacs.d/elisp/init-startup.el" src emacs-lisp :lines "1-2"
** Disable Unnecessary Interface
   This need to be in the beginning of initialization to smooth the experience.
   #+INCLUDE: "~/.emacs.d/elisp/init-startup.el" src emacs-lisp :lines "4-8"
** Optimization
   Avoid garbage collection during startup.
   #+INCLUDE: "~/.emacs.d/elisp/init-startup.el" src emacs-lisp :lines "10-19"
   Unset file name handler alist.
   #+INCLUDE: "~/.emacs.d/elisp/init-startup.el" src emacs-lisp :lines "20-28"
* Package Management
